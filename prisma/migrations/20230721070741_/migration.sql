...
CREATE TABLE "UserItem" (
    ...
    "archive" TEXT DEFAULT 'undefined',
    "currentRank" INTEGER NOT NULL DEFAULT 0,
    "potentialRank" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "UserList" (
    ...
    "userId" TEXT NOT NULL,
    "archive" TEXT DEFAULT 'undefined',
    "parentListId" TEXT DEFAULT 'undefined',
    "parentListUserId" TEXT DEFAULT 'undefined',
...
-- AddForeignKey
ALTER TABLE "UserItem" ADD CONSTRAINT "UserItem_listId_fkey" FOREIGN KEY ("listId") REFERENCES "UserList"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
